...
var Button = function (_a) {
    ...
    var height = React__default["default"].useMemo(function () {
        if (size === "small")
            return "h-6";
        if (size === "large")
            return "h-10";
    ...
    // color
    var color = React__default["default"].useMemo(function () {
    ...
    // background
    var background = React__default["default"].useMemo(function () {
        if (buttonType === "primary")
            return "bg-primary";
        return "bg-transparent";
    }, [buttonType]);
    // border
    var border = React__default["default"].useMemo(function () {
        if (buttonType === "primary")
    ...
    // radius
    var radius = React__default["default"].useMemo(function () {
        if (shape === "circle")
            return "rounded-full";
        if (shape === "round")
    ...
    return (React__default["default"].createElement("button", __assign({ className: cx("px-2", height, color, background, border, radius, className) }, rest), children));
};
...
var Title = function (_a) {
    ...
    var fontSize = React__default["default"].useMemo(function () {
        if (level === 5)
    ...
    return (React__default["default"].createElement(Heading, { className: cx('text-txt-black font-medium', fontSize, className) }, children));
};
...
var ModalContainer = function (_a, ref) {
    ...
    var widthStyle = React__default["default"].useMemo(function () {
        return "w-[".concat(width, "]");
    }, [width]);
    return (React__default["default"].createElement("div", __assign({ ref: ref, className: cx("h-max min-h-min-modal min-w-min-modal z-10 bg-white rounded", "flex flex-col justify-between animate-blowUp", widthStyle), style: { width: "".concat(width) } }, rest), children));
};
var ModalContainer$1 = React__default["default"].forwardRef(ModalContainer);
...
var ModalHeader = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: cx('relative h-16 flex justify-center items-center border-b border-bd-modal', className) },
        React__default["default"].createElement(Title, { level: 3 }, title),
        React__default["default"].createElement(Button, { buttonType: 'text', className: 'absolute right-0 text-xl font-semibold', onClick: function () { return handleClose(); } }, "\u2715")));
};
...
var ModalFooter = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: cx('h-16 border-t border-bd-modal flex items-center justify-end p-4', className) },
        React__default["default"].createElement(Button, { buttonType: 'default', size: "large", className: "w-24", onClick: function () { return handleCancel(); } }, cancelText),
        React__default["default"].createElement(Button, { buttonType: 'primary', size: "large", className: "w-24 ml-4", onClick: function () { return handleOk(); } }, okText)));
};
...
var Modal = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: cx('modal', maskClass, { hide: !visible }), onClick: function (e) { return handleMaskClick(e); } },
        React__default["default"].createElement(ModalContainer$1, null,
            header === null && null,
            header && header,
            !header && (React__default["default"].createElement(ModalHeader, { title: title, onClose: onClose, className: headerClass })),
            React__default["default"].createElement("div", { className: cx("flex-1 p-4", bodyClass) }, children),
            footer === null && null,
            footer && footer,
            !footer && (React__default["default"].createElement(ModalFooter, { className: footerClass, cancelText: cancelText, okText: okText, onCancel: onCancel, onOk: onOk })))));
};

var SpinnerOverlay = function (_a) {
    var children = _a.children;
    return (React__default["default"].createElement("div", { className: "fixed top-0 left-0 w-screen h-screen bg-spinner z-[50]" }, children));
};
...
var Spinner = function (_a) {
    ...
    if (type === 'default')
        return React__default["default"].createElement("div", { className: cx("spinner", spinnerClass), style: __assign({}, color) });
    return (React__default["default"].createElement(SpinnerOverlay, null,
        React__default["default"].createElement("div", { className: cx("spinner absolute z-[50] inset-1/2", spinnerClass), style: __assign({}, color) })));
};
